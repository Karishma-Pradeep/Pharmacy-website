		...
		<div class="top_banner two">
			<div class="container">
			       <div class="sub-hd-inner">
                                   <h3 class="tittle"><b>Medical</b><span>Stores</span></h3>
					</div>
			</div>
			...
			<div class="bottom-top">				
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <?php
                                    $rr=mysql_query("select * from storeregister");
                                    while ($hh=mysql_fetch_row($rr))
                                    {
                                    ?>
                                    <center><img src="piks/<?php echo $hh[7]?>" width="150px;" height="80px;"></center>
                                    <h3><?php echo $hh[1]?></h3>
                                    <h4><?php echo $hh[3]?></h4>
                                    <h4><?php echo $hh[2]?></h4>
                                    <h4><?php echo $hh[4]?></h4>
                                    <?php
                                             ...
                                             elseif ($hh[8]==2) 
                                          {
                                             ...
                                             {
                                             ?>
                                               <a href="medicalapprove.php?t=<?php echo $hh[0]?>" class="btn btn-warning">Approve</a>
                                               <a href="medicalapprove.php?k=<?php echo $hh[0]?>" class="btn btn-danger">Deny</a>
                                             <?php
                                            ...
                                            if(isset($_GET['t']))
                                             {
                                                 $t=$_GET['t'];
                                                 $y=mysql_query("update storeregister set st='1' where id='$t'");
                                             }
                                             if(isset($_GET['k']))
                                             {
                                                 $u=$_GET['k'];
                                                 $p=mysql_query("delete from storeregister where id='$u'");
                                             }
                                             ?> 
