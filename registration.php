		...
		<div class="top_banner two">
			<div class="container"  style="height: 500px;">
                            <div class="sub-hd-inner"  style="position: relative;bottom: -50px;">
                                <h3 class="tittle">Our<span>Registration</span></h3>
                                                <br/>
                                                <span ><a style="color: #00cccc;" href="user.php"><u>User Register</u></a></span> 
                                                <span><a style="color: white;" href="storeregister.php"><u>Store Register</u></a></span>
					</div>
			</div>
		</div>
