		...
		<div class="top_banner two">
			<div class="container"  style="height: 100px;">
                            <div class="sub-hd-inner"  style="position: relative;bottom: -50px;">
                                <div style="color: #1ba1a5;position: relative;bottom: -10px;">
                                         ...
                                         {
                                             $o=$_GET['o'];
                                             $rr=mysql_query("select * from storeregister where id='$o'");
                                             $aa=mysql_fetch_row($rr);                                             
                                             ?>
                                    <center><img src="piks/<?php echo $aa[7]?>" class="img img-responsive img-circle" width="450px;" height="250px;"></center>
                      <h3 class="tittle"><span>
                      <?php
                      echo $aa[1];
                      ?>
                          </span></h3>
                                    <br/>
<h3 style="color: white;"><i>Located in</i>   <span style="color: #00cccc;"><?php echo $aa[4]?></span></h3>
 <h3 style="color: white;"><i>Contact in</i>   <span style="color: #00cccc;"><?php echo $aa[2]?></span></h3>
 <h3 style="color: white;"><i>Mail Your Query On</i> <span style="color: #00cccc;"><?php echo $aa[3]?></span></h3>
 <br/>
 <a href="availablemedicine.php?k=<?php echo $aa[1]?>" class="btn btn-primary">Available Medicines</a>
                                             <?php
                                         }
                                           ?>
                                     <br/> 
