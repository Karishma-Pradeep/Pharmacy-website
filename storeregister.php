...
if(isset($_POST['register']))
{
    ...
    $i=mysql_query("insert into storeregister values('','$a','$b','$c','$d','$e','$f','$g','0')"); 
    $j=mysql_query("insert into login values('','$e','$f','store')");
                            ...
                            var a=document.getElementById("sname").value;                          
                             if(a==null || a=="")
                             {
                                 document.getElementById("sname").style.borderColor="red";
                                  document.getElementById("n1").innerHTML="<font color='red'>Please Enter Your Store Name!</font>";
                                  document.getElementById("sname").focus();
                             }
                           else
                            {
                                document.getElementById("sname").style.borderColor="blue";
		...
		<div class="top_banner two">
			<div class="container">
			       <div class="sub-hd-inner">
                                   <h3 style="position: relative;top: -95px;" class="tittle">Store<span>Registration</span></h3>
                                   
                                                <div class="bottom" style="height: 50%;position: relative; top: -90px;">
                                   ...
                                   <form method="post" enctype="multipart/form-data">
                                    <center>
                                        <table class="table table-responsive table-condensed" style="width: 400px;">
                                            <tr>
                                                <td style="color: white;"><b>StoreName</b></td>
                                                <td>
                 <input type="text" name="sname" placeholder="Enter Your Store Name" id="sname" class="form-control" onblur="msg1()"><span id="n1"></span>
                                                </td>
                                            </tr> 
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="password" name="pass" id="pass" placeholder="Enter Your Password" class="form-control"  onkeyup="msg1(this.value)"><span id="n6"></span>
                                                </td>
                                            </tr> 
                                             <tr>
                                                <td></td>
                                                <td>
                                                    <input type="file" name="file" id="file" value="Choose Pic"  onblur="msg7()"><span id="n7"></span>
                                                </td>
                                            </tr>
                                        </table>
