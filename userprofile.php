   ...
   <div class="bottom" style="position: relative; bottom: -5px;">
		<div class="container" style="position: relative;">
                    <div class="bottom-top">				
                                    <?php
                                    $rr=mysql_query("select * from userregister where username='$u'");
                                    $hh=mysql_fetch_row($rr);
                                    {
                                    ?>
                                    <center>
                                        <img src="piks/<?php echo $hh[7]?>" class="img img-responsive img-circle" width="150px;" height="90px;">
                                    </center>
                                    <h3><?php echo $hh[1]?></h3><br/>
                                    <h4><?php echo $hh[3]?></h4><br/>
                                    <h4><?php echo $hh[2]?></h4><br/>
                                    <h4><?php echo $hh[4]?></h4><br/>
                                    <?php
                                    }
                                    ?>
                                    <a href="updateprofile.php?n=<?php echo $hh[0]?>" class="btn btn-primary">Edit</a>
			</div>
		</div>
</div>                                                               
